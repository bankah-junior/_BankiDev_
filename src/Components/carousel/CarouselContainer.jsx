                ...
                <Slider ref={c => (this.slider = c)} {...settings}> 
                    <div key={1}> 
                        <div className="flex flex-col w-full">
                            ...
                            <div className="flex mt-2 px-2">
                                <button className="px-8 py-1 border-2 border-white rounded-lg mr-4">
                                    <a href={MindMeldDB.source}>Codes</a>
                                </button>
                                <button className="px-8 py-1 border-2 border-white rounded-lg">
                    ...
                    <div key={2}> 
                        <div className="flex flex-col w-full">
                            ...
                            <div className="flex mt-2 px-2">
                                <button className="px-8 py-1 border-2 border-white rounded-lg mr-4">
                                    <a href={MyRecipeDB.source}>Codes</a>
                                </button>
                                <button className="px-8 py-1 border-2 border-white rounded-lg">
                                    <a href={MyRecipeDB.visit}>View Site</a>
                                </button>
                            </div>
                        </div>
                    </div> 
                    <div key={3}> 
                        <div className="flex flex-col w-full">
                            ...
                            <div className="flex mt-2 px-2">
                                <button className="px-8 py-1 border-2 border-white rounded-lg mr-4">
                                    <a href={DropOfWisdomDB.source}>Codes</a>
                                </button>
                                <button className="px-8 py-1 border-2 border-white rounded-lg">
                                    <a href={DropOfWisdomDB.visit}>View Site</a>
                                </button>
                            </div>
                        </div> 
                    </div> 
                    <div key={4}> 
                        <div className="flex flex-col w-full">
                            ...
                            <div className="flex mt-2 px-2">
                                <button className="px-8 py-1 border-2 border-white rounded-lg mr-4">
                                    <a href={ConnectToBuyersDB.source}>Codes</a>
                                </button>
                                <button className="px-8 py-1 border-2 border-white rounded-lg">
                    ...
                    <div key={5}> 
                        <div className="flex flex-col w-full">
                            ...
                            <div className="flex mt-2 px-2">
                                <button className="px-8 py-1 border-2 border-white rounded-lg mr-4">
                                    <a href={NetflixCloneDB.source}>Codes</a>
                                </button>
                                <button className="px-8 py-1 border-2 border-white rounded-lg">
                    ...
                    <div key={6}> 
                        <div className="flex flex-col w-full">
                            ...
                            <div className="flex mt-2 px-2">
                                <button className="px-8 py-1 border-2 border-white rounded-lg mr-4">
                                    <a href={ChattersDB.source}>Codes</a>
                                </button>
                                <button className="px-8 py-1 border-2 border-white rounded-lg">
