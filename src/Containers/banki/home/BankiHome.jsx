      ...
      <div className="banki__Conatiner text-white">
        ...
        <div className="nav-header pb-8">
          ...
          <div className="header px-8 md:px-24 py-16 mb-8" id='home' style={{backgroundColor: 'rgba(0,0,0,0.4)'}}>
            <h2 className='font-bold md:text-4xl text-2xl'>ANTHONY BEKOE BANKAH</h2>            
            <h3 className='font-bold md:text-2xl text-xl'>AS FOREX TRADER </h3>
        ...
        <div className="about-section px-8 md:px-24 py-8" id='about'>
          ...
          <div className="flex flex-row-reverse">
            ...
            <div className='md:w-100-30' >
              ...
              <SubjectBody subject={ AboutDB.dev.subject } body={ AboutDB.dev.body } link={AboutDB.dev.devLink.link} LinkName={AboutDB.dev.devLink.name} />
            </div>
          </div>
        </div>
        ...
        <div className="credits px-8 md:px-24 py-8">
          ...
          <div className='flex flex-wrap md:justify-between justify-center items-center w-full'>
            ...
            <CC CCicon={<FcBusinesswoman size="35" color='#000'/>} CCtitle={"......"} CCname={"Olivia Dosimey"} />
            <CC CCicon={<FcBusinessman size="35" color='#000'/>} CCtitle={"Competitor"} CCname={"Samuel Boakye"} />
          </div>
        </div>
        {/* End of Credits */}
          ...
          <div className="advice-container w-full flex flex-col md:flex-row">
            ...
            <div className="advice-info p-4" >
              ...
              <ol>
                ...
                <li className='my-2'>4) <u>Time Managemet</u>: You can create a daily or weekly schedule that outlines your activities. These strategies will help: Creating a Schedule, Prioritizing Tasks, Limiting distractions and Taking Breaks.</li>
        ...
        <div className="contact-section px-8 md:px-24 py-8 reddish-bg" id="contact">
          ...
          <div className="social flex justify-around mt-4">
            ...
            <a href='https://www.youtube.com/@welearn2?sub_confirmation=1' title='YouTube'> <AiFillYoutube size={30} /> </a>
          </div>
        </div>
        {/* End of Contact */}
