export const MindMeldDB = {
  title: 'MindMeld',
  description: "This is an AI based website where users can read about AI",
...
export const MyRecipeDB = {
  title: 'My Recipe',
  description:"*Add recipe *Delete recipe *Search recipe *Sort Recipe",
...
export const ConnectToBuyersDB = {
  ...
  description: "This is a simple shopping site with cool features",
...
export const DropOfWisdomDB = {
  ...
  description: "Login and signup feature enabled. All data stored in database",
