...
export const MyRecipeDB = {
  ...
  image: '../../../assets/Projects/MyRecipe.PNG',
  tags: "Node, MongoDB, Express JavaScript",
  source: 'https://github.com/bankah-junior/My-Recipe',
  visit: 'https://github.com/bankah-junior/',
  id: 1,
}

export const ConnectToBuyersDB = {
  title: 'Connect To Buyers',
  description: "This is a simple shopping site with cool features. Its simplicity makes it stands out. Procedure to purchase a product is stated out clearly. It's only frontend.",
  image: '../../../assets/Projects/CTB.PNG',
    tags: "HTML, CSS, JavaScript",
  source: 'https://github.com/bankah-junior/Frontend-Part-2',
  visit: 'https://ctbs.netlify.app',
  id: 2,
}
...
export const DropOfWisdomDB = {
  ...
  image: '../../../assets/Projects/DropOfWisdom.PNG',
...
export const TheGuide = {
  title: 'The Guide',
  description: "Generating a Personnal TimeTable always give some people headache. So I took it upon myself to design and develop this website that aids generating personal timetable.",
